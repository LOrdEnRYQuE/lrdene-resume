...
export default function QRSolutionsPage() {
  ...
  const copy = de
    ? {
        ...
        leadLoadForm: "Anfrageformular laden",
    ...
    : {
        ...
        leadSuccess: "Your request was sent successfully. I will get back to you shortly.",
        leadError: "Could not send right now. Please try again in a moment.",
        leadLoadForm: "Load Inquiry Form",
        leadPrivacyConsentPrefix:
      ...
      <div className="container">
        ...
        <section className={styles.section}>
          <div className={styles.leadCard}>
            ...
            <p>{copy.leadDesc}</p>
            {!showLeadForm ? (
              <button type="button" className="magnetic-button" onClick={() => setShowLeadForm(true)}>
                {copy.leadLoadForm}
              </button>
            ) : (
              <QRSolutionsLeadForm copy={copy} />
            )}
          </div>
        </section>
