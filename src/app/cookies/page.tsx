...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = isDe ? "Cookie-Richtlinie" : "Cookie Policy";
  const description = isDe
    ? "Cookie-Richtlinie und Einwilligungssteuerung für LOrdEnRYQuE."
    : "Cookie policy and consent controls for LOrdEnRYQuE.";
